...
function draw() {
  ...
  // looping details around layer 4
  let spacing = 1.1;
  ...
  fill(0);
  textSize(25);
  text(timeDisplay4, width / 5, height / 2);
  ...
  fill(0);
  textSize(25);
  text(timeDisplay3, width - width / 1.8, height / 2);
  ...
  fill(0);
  textSize(25);
  text(timeDisplay2, width - width / 2.7, height / 2);
  ...
  push();
  translate(width - width / 5, height / 2);
  rotate(angle1);
  fill(100, 150, 200);
  drawingContext.setLineDash([10, 50]);
  ...
  fill(0);
  textSize(25);
  text(timeDisplay1, width - width / 4.3, height / 2);
  ...
  fill(0);
  textSize(25);
  text(timeDisplay0, width - width / 9, height / 2);
